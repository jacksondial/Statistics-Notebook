...
#### Model Selection <a href="javascript:showhide('selection')" style="font-size:.6em;color:skyblue;">(Expand)</a>

<span class="expand-caption">Selecting the best model to fit your data...</span>

<div id="selection" style="display:none;">

Some tips that I remember being really helpful:

- Coloring by categorical variables
- Pairs plots, pairs plots, pairs plots
- Using the * when defining your lm, to include all the addition and interaction terms
- Don't be afraid to group continuous variables into categorical variables if it helps your lm and makes sense
